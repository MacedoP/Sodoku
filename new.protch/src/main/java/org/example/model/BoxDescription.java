...
public final class BoxDescription {
    ...
    public static final BoxDescription TOP_LEFT = new BoxDescription(
            0, 3, 0, 3);
    public static final BoxDescription TOP_MIDDLE = new BoxDescription(
            0, 3, 3, 6);
    public static final BoxDescription TOP_RIGHT = new BoxDescription(
            0, 3, 6, 9);

    public static final BoxDescription MIDDLE_LEFT = new BoxDescription(
            3, 6, 0, 3);
    public static final BoxDescription MIDDLE_MIDDLE = new BoxDescription(
            3, 6, 3, 6);
    public static final BoxDescription MIDDLE_RIGHT = new BoxDescription(
            3, 6, 6, 9);

    public static final BoxDescription BOTTOM_LEFT = new BoxDescription(
            6, 9, 0, 3);
    public static final BoxDescription BOTTOM_MIDDLE = new BoxDescription(
            6, 9, 3, 6);
    public static final BoxDescription BOTTOM_RIGHT = new BoxDescription(
            6, 9, 6, 9);
